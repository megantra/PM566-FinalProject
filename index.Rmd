---
title: "PM566 Final Project - Use of Contraception for Women at Risk for Unintended Pregnancy "
author: "Megan Tran"
output: 
    html_document:
        toc: TRUE
...
The dataset was taken from the California Health and Human Services Agency webiste: https://data.chhs.ca.gov/dataset/contraceptive-care-for-women-use-by-race-ethnicity-contraceptive-type-and-age-group/resource/12a73f54-dcf4-4e38-843c-e988385be69b.
...
ggplotly_p3_bar
```
This bar graph indicates that women of Black and Hispanic race use contraception at a lower rate than women of other races. This observation should be considered for future research. There could potentially be lack of access, resources, or health education for these racial groups. 
